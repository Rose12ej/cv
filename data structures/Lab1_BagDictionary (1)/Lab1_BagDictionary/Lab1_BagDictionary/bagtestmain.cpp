...
int main() {
	...
	cout << "Rosalia Nunez Leon -- CSIS 215 Programming Assignment 1 -- Bag Dictionary" << endl << endl;
	...
	cout << "TESTING BAG FUNCTION" << endl;

	//operator += function
	KVpair<int,string> item(12,"COW");
	myBag += item;
	cout << "OPERATOR += : size of bag " << myBag.numItems() << endl;

	//inspect top function
	cout << "INSPECT TOP: ";
	KVpair<int,string> top;
	myBag.inspectTop(top);
	cout << top.key() << " " << top.value() << endl;
